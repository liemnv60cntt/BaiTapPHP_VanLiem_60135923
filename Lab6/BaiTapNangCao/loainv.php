...
<body>
    ...
    $strSQL = "SELECT * FROM loainv LIMIT $offset, $rowsPerPage";
    ...
    if (mysqli_num_rows($result) == 0) {
        ...
        echo "<h1 style='color: #0099ff; font-weight: bold;' align='center' class='rounded shadow'>THÔNG TIN LOẠI NHÂN VIÊN</h1>
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            if ($stt % 2 != 0) {
                ...
                echo "<td><a href='sua_loainv.php?maLoaiNV=".$row[0]."' class='btn btn-warning shadow'>&nbsp<i class='far fa-edit' style='font-size:24px'></i></a></td>";
                echo "<td><a href='xoa_loainv.php?maLoaiNV=".$row[0]."' class='btn btn-danger shadow'>&nbsp<i class='far fa-trash-alt' style='font-size:24px'></i>&nbsp</a></td>";
                echo "</tr>";
            } else {
        ...
        echo '</table>';
        $re = mysqli_query($dbc, 'select * from loainv');
